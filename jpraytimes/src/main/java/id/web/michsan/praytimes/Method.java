...
public class Method {
	 ...
	 * Russian Umma Muslim
	 */
	public static final Method RDUM;
	
	/**
	 * Custom 
	 */
	public static final Method CUSTOM;
	...
	static {
		...
		RDUM = new Method("RDUM");
		RDUM.configure(Time.FAJR, angle(0));
		RDUM.configure(Time.ISHA, minutes(90));
		
		CUSTOM = new Method("CUSTOM");
	}
