...
import com.koylubaevnt.jpraytimes.forms.components.Tooltips;
...
public class HideToSystemTray extends JFrame{
    ...
    HideToSystemTray(){
        ...
        if(SystemTray.isSupported()){
            ...
            Image image = Tooltips.createImage("/com/koylubaevnt/jpraytimes/images/tray_icon.gif", I18n.resourceBundle.getString("tray_icon"));//Toolkit.getDefaultToolkit().getImage("/com/koylubaevnt/jpraytimes/images/tray_icon.gif");
